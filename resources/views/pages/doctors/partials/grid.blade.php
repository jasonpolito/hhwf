    ...
    @for ($i = 0; $i < 12; $i++)
        ...
        <x-col class="mb-8 md:w-1/2 lg:w-1/3" :$gutter>
            <a href="{{ route("pages.doctors.show") }}"
                class="block mb-4 overflow-hidden bg-center bg-cover border bg-slate-200 border-slate-400"
                style="padding-top: 100%; background-image: url({{ $img }})">
            ...
            <div
                ...
                <h3><a href="/location/show">{{ $doctors->random(1)->first() }}</a></h3>
            </div>
